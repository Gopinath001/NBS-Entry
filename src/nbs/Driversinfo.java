 ...
 * @author Zero
 */
public class Driversinfo extends javax.swing.JFrame {

    /**
     * Creates new form Driversinfo
     */
    public Driversinfo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Driversinfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Driversinfo().setVisible(true);
            }
        });
    }
